...
const LandingPage = () => {
    ...
    return (
        <main className='p-20 bg-gradient-to-r from-[#0a0b1a] via-[#141433] to-[#04040e]'>
                ...
                <nav className="container mx-auto p-6 lg:flex lg:items-center lg:justify-between">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex lg:hidden">
                            <button xcloak type="button" onClick={ () => setIsOpen(!isOpen) } className="text-gray-500 hover:text-gray-600 focus:text-gray-600 focus:outline-none dark:text-gray-200 dark:hover:text-gray-400 dark:focus:text-gray-400" aria-label="toggle menu">
                    ...
                    <div className='relative'>
                        <div xcloak className="absolute p-20 inset-x-0 z-20 w-auto mx-auto bg-blue-950 py-4 shadow-md transition-all duration-300 ease-in-out dark:bg-gray-900 lg:relative lg:top-0 lg:mt-0 lg:flex lg:w-auto lg:translate-x-0 lg:items-center lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:dark:bg-transparent">
                ...
                <div className="mx-auto px-6 py-16 text-center">
                    <section className="w-full">
                        <img
                            ...
                            className="object-fill w-full h-[200px] md:h-[400px]"
                            alt="Image alt text"
                        />
                    </section>
            ...
            <section className="pt-20 md:pt-40 bg-gradient-to-r from-[#0a0b1a] via-[#141433] to-[#282843]">
                <div className="mx-auto px-5 md:px-10 py-10">
                    <h1 className="text-center text-2xl md:text-3xl font-bold tracking-wider capitalize text-yellow-600 dark:text-white lg:text-4xl font-Arquitecta">
                        FIND WHAT MOVES YOU
                    </h1>
                    <p className="py-10 md:py-20 text-center tracking-wide leading-relaxed text-sm md:text-base
      text-gray-400 dark:text-gray-300 font-Proxima-Nova">
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-20 xl:mt-12">
                        <div>
                            <img
                                ...
                                alt=""
                            />
                            <h2 className="mt-6 md:mt-10 text-sm md:text-base font-semibold capitalize text-gray-300 dark:text-white">
                                YOGA
                            </h2>
                            <p className="mt-2 text-xs md:text-sm tracking-wider text-gray-400 dark:text-blue-400">
            ...
            <section className="mt-20 md:mt-40 bg-gradient-to-r from-[#0a0b1a] via-[#141433] to-[#282843]">
                <div className="h-[16rem] dark:bg-gray-800">
                    <div className="container mx-auto px-6 py-10">
                        <h1 className="mt-10 md:mt-60 text-center text-2xl md:text-3xl font-bold tracking-wider capitalize text-yellow-600 dark:text-white lg:text-4xl font-Arquitecta">
                            MEET YOUR INSTRUCTORS
                        </h1>
                        <div className="mx-auto mt-6 flex justify-center">
                            <span className="inline-block h-1 w-20 md:w-40 rounded-full bg-blue-500" />
                            <span className="mx-1 inline-block h-1 w-2 md:w-3 rounded-full bg-blue-500" />
                            <span className="inline-block h-1 w-1 rounded-full bg-blue-500" />
                        </div>
                        <p className="py-10 md:py-20 text-center tracking-wide leading-relaxed text-sm md:text-base text-gray-400 dark:text-gray-300 font-Proxima-Nova">
                            We work with the best so you can feel your best. Our team of top instructors will empower
                            <br />
                            you to reach all your fitness and wellness goals and enjoy the journey on the way.
                        </p>
                    </div>
                    <div className="text-center pb-5 md:pb-16">
